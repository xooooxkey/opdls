...
def upload_file_in_chunks(url, file_path):
    ...
    cy = f'''curl -L -X POST -H "Accept: application/vnd.github+json" -H "Authorization: Bearer {vtoken}" -H "X-GitHub-Api-Version: 2022-11-28" -H "Content-Type: application/octet-stream" {url} -T "{file_path}"'''
